...
export const WeaponSkillDefs = {
  ...
  stone_axe: {
    ...
    cooldown: 13,
    type: 'shockwave',
    params: { radius: 120, dmgMult: 1.5, waves: 1 },
    color: '#aa8',
  },
  sword: {
    name: '鉄の旋風',
  ...
  fire_sword: {
    ...
    cooldown: 11,
    type: 'shockwave',
    params: { radius: 160, dmgMult: 2.5, waves: 2 },
    color: '#f62',
  },
  dark_blade: {
    name: '暗黒波動',
  ...
  sky_sword: {
    ...
    params: { bounces: 8, dmgMult: 3.0, bounceRange: 150 },
    color: '#ff4',
  },
  legendary_blade: {
    name: '伝説の極光斬',
    ...
    cooldown: 7,
    type: 'shockwave',
    params: { radius: 300, dmgMult: 5.0, waves: 3 },
    color: '#ffa',
  },
  time_blade: {
    name: '時空断絶',
  ...
  thunder_spear: {
    ...
    cooldown: 8,
    type: 'chain_lightning',
    params: { bounces: 6, dmgMult: 2.5, bounceRange: 130 },
    color: '#ff8',
  },
  wind_lance: {
    name: '疾風突貫',
  ...
  phoenix_bow: {
    ...
    cooldown: 7,
    type: 'burn_zone',
    params: { radius: 100, dmgPerSec: 3.0, duration: 5 },
    color: '#f84',
  },
  cosmos_bow: {
    name: '星界崩壊',
  ...
  elder_staff: {
    ...
    cooldown: 10,
    type: 'barrier',
    params: { radius: 130, knockback: 60, dmgMult: 1.0, invincDuration: 1.5 },
    color: '#4a4',
  },
  aether_staff: {
    name: 'エーテル崩壊',
  ...
  ice_shield: {
    ...
    cooldown: 11,
    type: 'freeze_zone',
    params: { radius: 120, slowAmount: -40, duration: 3 },
    color: '#8ef',
  },
  lava_shield: {
    name: '溶岩の壁',
  ...
  star_shield: {
    ...
    cooldown: 7,
    type: 'shockwave',
    params: { radius: 220, dmgMult: 3.5, waves: 3 },
    color: '#ff8',
  },
  oblivion_shield: {
    name: '忘却の結界',
