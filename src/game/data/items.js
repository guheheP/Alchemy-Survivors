...
export const ItemBlueprints = {
  ...
  // ===== Rank 1: 初期レシピ (8種) =====
  sword: { id: 'sword', name: '鉄の剣', type: 'equipment', equipType: 'sword', baseValue: 32, image: '/art/items/sword.png' },
  ...
  // ===== Rank 2: 洞窟解放 (10種) =====
  fire_sword: { id: 'fire_sword', name: '炎の剣', type: 'equipment', equipType: 'sword', baseValue: 45, element: 'fire', image: '/art/items/fire_sword.png' },
  ice_shield: { id: 'ice_shield', name: '氷の盾', type: 'equipment', equipType: 'shield', baseValue: 40, element: 'ice', image: '/art/items/ice_shield.png' },
  ...
  dark_blade: { id: 'dark_blade', name: '暗黒の刃', type: 'equipment', equipType: 'sword', baseValue: 58, baseCritChance: 0.03, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/dark_blade.png' },
  fairy_necklace: { id: 'fairy_necklace', name: '妖精のネックレス', type: 'accessory', baseValue: 100, image: '/art/items/fairy_necklace.png' },
  poison_dagger: { id: 'poison_dagger', name: '毒塗りの短剣', type: 'equipment', equipType: 'dagger', baseValue: 60, baseCritChance: 0.06, element: 'poison', image: '/art/items/poison_dagger.png' },
  ...
  // ===== Rank 4: 火山解放 (12種) =====
  holy_sword: { id: 'holy_sword', name: '聖剣', type: 'equipment', equipType: 'sword', baseValue: 95, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/holy_sword.png' },
  ...
  lava_shield: { id: 'lava_shield', name: '溶岩の盾', type: 'equipment', equipType: 'shield', baseValue: 88, element: 'fire', image: '/art/items/lava_shield.png' },
  ...
  mithril_sword: { id: 'mithril_sword', name: 'ミスリルの剣', type: 'equipment', equipType: 'sword', baseValue: 130, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/mithril_sword.png' },
  mithril_shield: { id: 'mithril_shield', name: 'ミスリルの盾', type: 'equipment', equipType: 'shield', baseValue: 120, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/mithril_shield.png' },
  void_amulet: { id: 'void_amulet', name: '虚空のアミュレット', type: 'accessory', baseValue: 390, image: '/art/items/void_amulet.png' },
  frost_blade: { id: 'frost_blade', name: '凍てつく刃', type: 'equipment', equipType: 'sword', baseValue: 122, element: 'ice', image: '/art/items/frost_blade.png' },
  ...
  sea_serpent_whip: { id: 'sea_serpent_whip', name: '海竜の鞭', type: 'equipment', equipType: 'dagger', baseValue: 128, baseCritChance: 0.08, element: 'water', image: '/art/items/sea_serpent_whip.png' },
  ...
  // ===== Rank 6: 竜の巣解放 (12種) =====
  dragon_slayer: { id: 'dragon_slayer', name: '竜殺しの大剣', type: 'equipment', equipType: 'sword', baseValue: 175, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/dragon_slayer.png' },
  ...
  void_blade: { id: 'void_blade', name: '虚無の剣', type: 'equipment', equipType: 'sword', baseValue: 170, baseCritChance: 0.04, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/void_blade.png' },
  ...
  scale_shield: { id: 'scale_shield', name: '竜鱗の大盾', type: 'equipment', equipType: 'shield', baseValue: 158, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/scale_shield.png' },

  // ===== Rank 7: 天空解放 (12種) =====
  sky_sword: { id: 'sky_sword', name: '天空の剣', type: 'equipment', equipType: 'sword', baseValue: 220, element: 'lightning', image: '/art/items/sky_sword.png' },
  time_hourglass: { id: 'time_hourglass', name: '時の砂時計', type: 'accessory', baseValue: 780, image: '/art/items/time_hourglass.png' },
  star_shield: { id: 'star_shield', name: '星盾', type: 'equipment', equipType: 'shield', baseValue: 200, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/star_shield.png' },
  ...
  // ===== Rank 8: 最終レシピ (10種) =====
  legendary_blade: { id: 'legendary_blade', name: '伝説の刃', type: 'equipment', equipType: 'sword', baseValue: 275, baseCritChance: 0.05, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/legendary_blade.png' },
  world_tree_staff: { id: 'world_tree_staff', name: '世界樹の杖', type: 'equipment', equipType: 'staff', baseValue: 275, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/world_tree_staff.png' },
  genesis_armor: { id: 'genesis_armor', name: '始原の鎧', type: 'equipment', equipType: 'armor', baseValue: 900, image: '/art/items/genesis_armor.png' },
  time_blade: { id: 'time_blade', name: '時渡りの剣', type: 'equipment', equipType: 'sword', baseValue: 265, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/time_blade.png' },
  ...
  oblivion_shield: { id: 'oblivion_shield', name: '忘却の盾', type: 'equipment', equipType: 'shield', baseValue: 250, baseDamageMultiplier: 1.25, element: 'none', image: '/art/items/oblivion_shield.png' },
