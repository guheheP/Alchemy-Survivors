...
export const TraitDefs = {
  ...
  '光る': { name: '光る', rarity: 'common', color: 'gray', description: '調合品質+1, ドロップ率+1%', effects: { craftQualityBonus: 1, runDropRate: 0.01 } },
  ...
  '幸運': { name: '幸運', rarity: 'common', color: 'gray', description: 'ドロップ率+1.6%', effects: { runDropRate: 0.016 } },
  ...
  '売値UP': { name: '売値UP', rarity: 'uncommon', color: 'green', description: '調合品質+2, ドロップ率+3%', effects: { craftQualityBonus: 2, runDropRate: 0.03 } },
  ...
  '強運': { name: '強運', rarity: 'uncommon', color: 'green', description: 'ドロップ率+3%', effects: { runDropRate: 0.03 } },
  ...
  // スタンドアロン
  '採取量UP': { name: '採取量UP', rarity: 'uncommon', color: 'green', description: 'ドロップ率+5%', effects: { runDropRate: 0.05 } },
  ...
  '売値UP+': { name: '売値UP+', rarity: 'rare', color: 'blue', description: '調合品質+4, ドロップ率+5%', effects: { craftQualityBonus: 4, runDropRate: 0.05 } },
  ...
  '天運': { name: '天運', rarity: 'rare', color: 'blue', description: 'ドロップ率+5%', effects: { runDropRate: 0.05 } },
  ...
  '黄金の輝き': { name: '黄金の輝き', rarity: 'epic', color: 'purple', description: '調合品質+8, ドロップ率+8%', effects: { craftQualityBonus: 8, runDropRate: 0.08 } },
  ...
  '運命の導き': { name: '運命の導き', rarity: 'epic', color: 'purple', description: 'ドロップ率+8%', effects: { runDropRate: 0.08 } },
