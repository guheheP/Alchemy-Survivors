...
export const ItemBlueprints = {
  ...
  // ===== Rank 1: 初期レシピ (8種) =====
  sword: { id: 'sword', name: '鉄の剣', type: 'equipment', equipType: 'sword', baseValue: 32, baseDamageMultiplier: 1.2, image: '/art/items/sword.png' },
  ...
  stone_axe: { id: 'stone_axe', name: '石斧', type: 'equipment', equipType: 'sword', baseValue: 28, baseDamageMultiplier: 1.2, image: '/art/items/stone_axe.png' },
  ...
  // ===== Rank 2: 洞窟解放 (10種) =====
  fire_sword: { id: 'fire_sword', name: '炎の剣', type: 'equipment', equipType: 'sword', baseValue: 45, baseDamageMultiplier: 1.2, element: 'fire', image: '/art/items/fire_sword.png' },
  ...
  dark_blade: { id: 'dark_blade', name: '暗黒の刃', type: 'equipment', equipType: 'sword', baseValue: 58, baseCritChance: 0.03, baseDamageMultiplier: 1.5, element: 'none', image: '/art/items/dark_blade.png' },
  ...
  // ===== Rank 4: 火山解放 (12種) =====
  holy_sword: { id: 'holy_sword', name: '聖剣', type: 'equipment', equipType: 'sword', baseValue: 95, baseDamageMultiplier: 1.5, element: 'none', image: '/art/items/holy_sword.png' },
  ...
  mithril_sword: { id: 'mithril_sword', name: 'ミスリルの剣', type: 'equipment', equipType: 'sword', baseValue: 130, baseDamageMultiplier: 1.5, element: 'none', image: '/art/items/mithril_sword.png' },
  ...
  frost_blade: { id: 'frost_blade', name: '凍てつく刃', type: 'equipment', equipType: 'sword', baseValue: 122, baseDamageMultiplier: 1.2, element: 'ice', image: '/art/items/frost_blade.png' },
  ...
  // ===== Rank 6: 竜の巣解放 (12種) =====
  dragon_slayer: { id: 'dragon_slayer', name: '竜殺しの大剣', type: 'equipment', equipType: 'sword', baseValue: 175, baseDamageMultiplier: 1.5, element: 'none', image: '/art/items/dragon_slayer.png' },
  ...
  void_blade: { id: 'void_blade', name: '虚無の剣', type: 'equipment', equipType: 'sword', baseValue: 170, baseCritChance: 0.04, baseDamageMultiplier: 1.5, element: 'none', image: '/art/items/void_blade.png' },
  ...
  // ===== Rank 7: 天空解放 (12種) =====
  sky_sword: { id: 'sky_sword', name: '天空の剣', type: 'equipment', equipType: 'sword', baseValue: 220, baseDamageMultiplier: 1.2, element: 'lightning', image: '/art/items/sky_sword.png' },
  ...
  // ===== Rank 8: 最終レシピ (10種) =====
  legendary_blade: { id: 'legendary_blade', name: '伝説の刃', type: 'equipment', equipType: 'sword', baseValue: 275, baseCritChance: 0.05, baseDamageMultiplier: 1.5, element: 'none', image: '/art/items/legendary_blade.png' },
  ...
  time_blade: { id: 'time_blade', name: '時渡りの剣', type: 'equipment', equipType: 'sword', baseValue: 265, baseDamageMultiplier: 1.5, element: 'none', image: '/art/items/time_blade.png' },
