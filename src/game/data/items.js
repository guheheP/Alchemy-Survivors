...
export const ItemBlueprints = {
  ...
  silver_dagger: { id: 'silver_dagger', name: '銀の短剣', type: 'equipment', equipType: 'dagger', baseValue: 70, baseCritChance: 0.05, image: '/art/items/silver_dagger.png' },
  leather_armor: { id: 'leather_armor', name: '革鎧', type: 'equipment', equipType: 'armor', baseValue: 60, image: '/art/items/leather_armor.png' },
  iron_spear: { id: 'iron_spear', name: '鉄の槍', type: 'equipment', equipType: 'spear', baseValue: 65, image: '/art/items/iron_spear.png' },
  ...
  // ===== Rank 3: 森解放 (12種) =====
  mage_staff: { id: 'mage_staff', name: '魔法の杖', type: 'equipment', equipType: 'staff', baseValue: 150, image: '/art/items/mage_staff.png' },
  ...
  dark_blade: { id: 'dark_blade', name: '暗黒の刃', type: 'equipment', equipType: 'sword', baseValue: 130, baseCritChance: 0.03, image: '/art/items/dark_blade.png' },
  ...
  // ===== Rank 4: 火山解放 (12種) =====
  holy_sword: { id: 'holy_sword', name: '聖剣', type: 'equipment', equipType: 'sword', baseValue: 315, image: '/art/items/holy_sword.png' },
  ...
  moonlight_staff: { id: 'moonlight_staff', name: '月光の杖', type: 'equipment', equipType: 'staff', baseValue: 240, image: '/art/items/moonlight_staff.png' },
  ...
  // ===== Rank 5: 深海解放 (12種) =====
  trident: { id: 'trident', name: '海神の三叉槍', type: 'equipment', equipType: 'spear', baseValue: 400, image: '/art/items/trident.png' },
  ...
  tidal_bow: { id: 'tidal_bow', name: '潮流の弓', type: 'equipment', equipType: 'bow', baseValue: 375, image: '/art/items/tidal_bow.png' },
  ...
  mithril_sword: { id: 'mithril_sword', name: 'ミスリルの剣', type: 'equipment', equipType: 'sword', baseValue: 440, image: '/art/items/mithril_sword.png' },
  mithril_shield: { id: 'mithril_shield', name: 'ミスリルの盾', type: 'equipment', equipType: 'shield', baseValue: 390, image: '/art/items/mithril_shield.png' },
  ...
  elder_staff: { id: 'elder_staff', name: '長老樹の杖', type: 'equipment', equipType: 'staff', baseValue: 325, image: '/art/items/elder_staff.png' },
  sea_serpent_whip: { id: 'sea_serpent_whip', name: '海竜の鞭', type: 'equipment', equipType: 'dagger', baseValue: 415, baseCritChance: 0.08, image: '/art/items/sea_serpent_whip.png' },
  ...
  // ===== Rank 6: 竜の巣解放 (12種) =====
  dragon_slayer: { id: 'dragon_slayer', name: '竜殺しの大剣', type: 'equipment', equipType: 'sword', baseValue: 565, image: '/art/items/dragon_slayer.png' },
  ...
  dragon_bow: { id: 'dragon_bow', name: '竜骨の弓', type: 'equipment', equipType: 'bow', baseValue: 540, baseCritChance: 0.04, image: '/art/items/dragon_bow.png' },
  phoenix_robe: { id: 'phoenix_robe', name: '不死鳥のローブ', type: 'equipment', equipType: 'robe', baseValue: 410, image: '/art/items/phoenix_robe.png' },
  void_blade: { id: 'void_blade', name: '虚無の剣', type: 'equipment', equipType: 'sword', baseValue: 575, baseCritChance: 0.04, image: '/art/items/void_blade.png' },
  ...
  scale_shield: { id: 'scale_shield', name: '竜鱗の大盾', type: 'equipment', equipType: 'shield', baseValue: 490, image: '/art/items/scale_shield.png' },
  ...
  star_shield: { id: 'star_shield', name: '星盾', type: 'equipment', equipType: 'shield', baseValue: 650, image: '/art/items/star_shield.png' },
  divine_armor: { id: 'divine_armor', name: '神鉄の鎧', type: 'equipment', equipType: 'armor', baseValue: 580, image: '/art/items/divine_armor.png' },
  aether_staff: { id: 'aether_staff', name: 'エーテルの杖', type: 'equipment', equipType: 'staff', baseValue: 700, image: '/art/items/aether_staff.png' },
  sky_bow: { id: 'sky_bow', name: '天翔ける弓', type: 'equipment', equipType: 'bow', baseValue: 675, image: '/art/items/sky_bow.png' },
  ...
  // ===== Rank 8: 最終レシピ (10種) =====
  legendary_blade: { id: 'legendary_blade', name: '伝説の刃', type: 'equipment', equipType: 'sword', baseValue: 1000, baseCritChance: 0.05, image: '/art/items/legendary_blade.png' },
  world_tree_staff: { id: 'world_tree_staff', name: '世界樹の杖', type: 'equipment', equipType: 'staff', baseValue: 1065, image: '/art/items/world_tree_staff.png' },
  genesis_armor: { id: 'genesis_armor', name: '始原の鎧', type: 'equipment', equipType: 'armor', baseValue: 900, image: '/art/items/genesis_armor.png' },
  time_blade: { id: 'time_blade', name: '時渡りの剣', type: 'equipment', equipType: 'sword', baseValue: 1025, image: '/art/items/time_blade.png' },
  ...
  cosmos_bow: { id: 'cosmos_bow', name: '星界弓コスモス', type: 'equipment', equipType: 'bow', baseValue: 1040, baseCritChance: 0.05, image: '/art/items/cosmos_bow.png' },
  ...
  oblivion_shield: { id: 'oblivion_shield', name: '忘却の盾', type: 'equipment', equipType: 'shield', baseValue: 965, image: '/art/items/oblivion_shield.png' },
