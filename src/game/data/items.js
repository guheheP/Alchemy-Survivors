...
export const ItemBlueprints = {
  ...
  silver_dagger: { id: 'silver_dagger', name: '銀の短剣', type: 'equipment', equipType: 'dagger', baseValue: 55, baseCritChance: 0.05, baseDamageMultiplier: 1.25, image: '/art/items/silver_dagger.png' },
  leather_armor: { id: 'leather_armor', name: '革鎧', type: 'equipment', equipType: 'armor', baseValue: 60, image: '/art/items/leather_armor.png' },
  iron_spear: { id: 'iron_spear', name: '鉄の槍', type: 'equipment', equipType: 'spear', baseValue: 50, baseDamageMultiplier: 1.25, image: '/art/items/iron_spear.png' },
  ...
  // ===== Rank 3: 森解放 (12種) =====
  mage_staff: { id: 'mage_staff', name: '魔法の杖', type: 'equipment', equipType: 'staff', baseValue: 120, baseDamageMultiplier: 1.25, image: '/art/items/mage_staff.png' },
  ...
  dark_blade: { id: 'dark_blade', name: '暗黒の刃', type: 'equipment', equipType: 'sword', baseValue: 105, baseCritChance: 0.03, baseDamageMultiplier: 1.25, image: '/art/items/dark_blade.png' },
  ...
  // ===== Rank 4: 火山解放 (12種) =====
  holy_sword: { id: 'holy_sword', name: '聖剣', type: 'equipment', equipType: 'sword', baseValue: 250, baseDamageMultiplier: 1.25, image: '/art/items/holy_sword.png' },
  ...
  moonlight_staff: { id: 'moonlight_staff', name: '月光の杖', type: 'equipment', equipType: 'staff', baseValue: 190, baseDamageMultiplier: 1.25, image: '/art/items/moonlight_staff.png' },
  ...
  // ===== Rank 6: 竜の巣解放 (12種) =====
  dragon_slayer: { id: 'dragon_slayer', name: '竜殺しの大剣', type: 'equipment', equipType: 'sword', baseValue: 450, baseDamageMultiplier: 1.25, image: '/art/items/dragon_slayer.png' },
  ...
  scale_shield: { id: 'scale_shield', name: '竜鱗の大盾', type: 'equipment', equipType: 'shield', baseValue: 390, baseDamageMultiplier: 1.25, image: '/art/items/scale_shield.png' },
  ...
  star_shield: { id: 'star_shield', name: '星盾', type: 'equipment', equipType: 'shield', baseValue: 520, baseDamageMultiplier: 1.25, image: '/art/items/star_shield.png' },
  divine_armor: { id: 'divine_armor', name: '神鉄の鎧', type: 'equipment', equipType: 'armor', baseValue: 580, image: '/art/items/divine_armor.png' },
  aether_staff: { id: 'aether_staff', name: 'エーテルの杖', type: 'equipment', equipType: 'staff', baseValue: 560, baseDamageMultiplier: 1.25, image: '/art/items/aether_staff.png' },
  sky_bow: { id: 'sky_bow', name: '天翔ける弓', type: 'equipment', equipType: 'bow', baseValue: 540, baseDamageMultiplier: 1.25, image: '/art/items/sky_bow.png' },
  ...
  // ===== Rank 8: 最終レシピ (10種) =====
  legendary_blade: { id: 'legendary_blade', name: '伝説の刃', type: 'equipment', equipType: 'sword', baseValue: 800, baseCritChance: 0.05, baseDamageMultiplier: 1.25, image: '/art/items/legendary_blade.png' },
  world_tree_staff: { id: 'world_tree_staff', name: '世界樹の杖', type: 'equipment', equipType: 'staff', baseValue: 850, baseDamageMultiplier: 1.25, image: '/art/items/world_tree_staff.png' },
  genesis_armor: { id: 'genesis_armor', name: '始原の鎧', type: 'equipment', equipType: 'armor', baseValue: 900, image: '/art/items/genesis_armor.png' },
  time_blade: { id: 'time_blade', name: '時渡りの剣', type: 'equipment', equipType: 'sword', baseValue: 820, baseDamageMultiplier: 1.25, image: '/art/items/time_blade.png' },
  ...
  cosmos_bow: { id: 'cosmos_bow', name: '星界弓コスモス', type: 'equipment', equipType: 'bow', baseValue: 830, baseCritChance: 0.05, baseDamageMultiplier: 1.25, image: '/art/items/cosmos_bow.png' },
  ...
  oblivion_shield: { id: 'oblivion_shield', name: '忘却の盾', type: 'equipment', equipType: 'shield', baseValue: 770, baseDamageMultiplier: 1.25, image: '/art/items/oblivion_shield.png' },
