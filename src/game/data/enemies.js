...
export const EnemyDefs = {
  ...
  // --- 火山 ---
  fire_elemental: { id: 'fire_elemental', name: '炎精霊', hp: 30, speed: 65, damage: 12, expValue: 3, radius: 10, color: '#f62' },
  lava_golem: { id: 'lava_golem', name: '溶岩ゴーレム', hp: 70, speed: 25, damage: 18, expValue: 5, radius: 18, color: '#a42' },
  fire_bat: { id: 'fire_bat', name: '火蝙蝠', hp: 15, speed: 100, damage: 8, expValue: 2, radius: 8, color: '#f84' },
  magma_worm: { id: 'magma_worm', name: 'マグマワーム', hp: 45, speed: 40, damage: 14, expValue: 4, radius: 14, color: '#d52' },

  // --- 深海 ---
  sea_serpent: { id: 'sea_serpent', name: 'シーサーペント', hp: 50, speed: 55, damage: 14, expValue: 4, radius: 14, color: '#28a' },
  jellyfish: { id: 'jellyfish', name: '電気クラゲ', hp: 20, speed: 35, damage: 10, expValue: 3, radius: 10, color: '#6cf' },
  deep_fish: { id: 'deep_fish', name: '深海魚', hp: 35, speed: 75, damage: 10, expValue: 3, radius: 10, color: '#148' },
