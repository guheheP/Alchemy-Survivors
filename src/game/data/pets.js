...
export const PetDefs = {
  slime: {
    ...
    icon: '🟢',
    spriteColor: '#7eb87e',
    description: 'アイテム自動回収半径 +75%、XPオーブを優先吸引',
    type: 'support',
    behavior: 'magnet',
    behaviorParams: { magnetMultiplier: 0.75, xpVacuum: true },
  ...
  wolf: {
    ...
    icon: '🐺',
    spriteColor: '#9a7e58',
    description: '近くの敵を自動で追跡して噛みつく（武器DPSの約45%）',
    type: 'combat',
    behavior: 'autoAttack',
    behaviorParams: { range: 100, cooldown: 1.2, damageMult: 0.45 },
  ...
  owl: {
    ...
    icon: '🦉',
    spriteColor: '#8a6e4e',
    description: '取得経験値 +35%、ボスドロップ確率 +20%',
    type: 'utility',
    behavior: 'xpBoost',
    behaviorParams: { expMultiplier: 0.35, dropBonus: 0.20 },
  ...
  imp: {
    ...
    icon: '👹',
    spriteColor: '#cc4488',
    description: '4.5秒毎に範囲爆発（魔法ダメージ）',
    type: 'combat',
    behavior: 'aoe',
    behaviorParams: { radius: 80, cooldown: 4.5, damageMult: 0.7 },
  ...
  dragonling: {
    ...
    icon: '🐲',
    spriteColor: '#ddaa44',
    description: '7秒毎に高威力ブレス、ボス被ダメージ +30%',
    type: 'combat',
    behavior: 'projectile',
    behaviorParams: { range: 240, cooldown: 7, damageMult: 3.5, bossBonus: 0.3 },
